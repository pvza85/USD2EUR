...
class svm_train {
	...
	private double[] do_cross_validation()
	{
		   ...
		   param.svm_type == svm_parameter.NU_SVR)
		{
			...
			result[0] = total_error/prob.l;
                        System.out.print("Cross Validation Squared correlation coefficient = "+
				((prob.l*sumvy-sumv*sumy)*(prob.l*sumvy-sumv*sumy))/
				((prob.l*sumvv-sumv*sumv)*(prob.l*sumyy-sumy*sumy))+"\n"
				);
                        result[1] = ((prob.l*sumvy-sumv*sumy)*(prob.l*sumvy-sumv*sumy))/
				((prob.l*sumvv-sumv*sumv)*(prob.l*sumyy-sumy*sumy));
		}
		else
		{
	...
	public double[] run(String argv[]) throws IOException
	{
            ...
            Formatter log = new Formatter(new FileWriter("log", true));
            ...
            if(cross_validation != 0)
            {
                    ...
                    log.format("MSE = %f  SCC = %f : %s  %s  %s  %s\n", fitness[0], fitness[1], argv[1], argv[3], argv[5], argv[7]);
            }
            else
            {
